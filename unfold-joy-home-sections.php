...
class UJ_Home_Sections_Plugin {
                    ...
                    <?php for ($i=1; $i<=3; $i++): ?>
                        <article class="uj-card-item uj-project-card">
                            ...
                            <div class="uj-card-body">
                                ...
                                <?php if (!empty($o['impact_'.$i.'_link'])): ?><a class="uj-text-link" href="<?php echo esc_url($o['impact_'.$i.'_link']); ?>">Learn More</a><?php endif; ?>
                            </div>
                        </article>
                    <?php endfor; ?>
                </div>
                    ...
                    <?php for ($i=1; $i<=3; $i++): ?>
                        <article class="uj-card-item uj-media-card">
                            ...
                            <div class="uj-card-body">
                                ...
                                <?php if (!empty($o['events_'.$i.'_link'])): ?><a class="uj-text-link" href="<?php echo esc_url($o['events_'.$i.'_link']); ?>">Read More</a><?php endif; ?>
                            </div>
                        </article>
                    <?php endfor; ?>
                </div>
                    ...
                    <?php for ($i=1; $i<=3; $i++): ?>
                        <article class="uj-card-item uj-news-card">
                            ...
                            <div class="uj-card-body">
                                ...
                                <?php if (!empty($o['news_'.$i.'_link'])): ?><a class="uj-text-link" href="<?php echo esc_url($o['news_'.$i.'_link']); ?>">Read More</a><?php endif; ?>
                            </div>
                        </article>
                    <?php endfor; ?>
                </div>
    ...
    private function frontend_css() {
        return '
        .uj-home-sections{--uj-pink:#ff3692;--uj-green:#00c867;--uj-blue:#001738;--uj-white:#ffffff;--uj-text:#334155;--uj-light:#f8fafc}
        .uj-home-sections *{box-sizing:border-box}
        .uj-home-sections .uj-container{width:min(1200px,92%);margin:0 auto}
        .uj-home-sections .uj-section{padding:90px 0}
        .uj-home-sections .uj-section-head{text-align:center;max-width:820px;margin:0 auto 44px}
        .uj-home-sections .uj-section-head h2{font-size:clamp(30px,4vw,48px);line-height:1.15;margin:16px 0 12px;color:var(--uj-blue);font-weight:800}
        .uj-home-sections .uj-section-head p{font-size:16px;line-height:1.8;color:var(--uj-text);margin:0 auto}
        .uj-home-sections .uj-badge{display:inline-flex;justify-content:center;align-items:center;min-width:165px;height:58px;padding:0 28px;border:2px solid var(--uj-pink);border-radius:999px;position:relative;background:transparent}
        ...
        .uj-home-sections .uj-card-item{background:#fff;border:1px solid #e5e7eb;border-radius:22px;overflow:hidden;box-shadow:0 18px 40px rgba(0,23,56,.08);height:100%;display:flex;flex-direction:column}
        .uj-home-sections .uj-card-image{aspect-ratio:16/10;background:#eef2f7;overflow:hidden}
        .uj-home-sections .uj-card-image img{width:100%;height:100%;object-fit:cover;display:block}
        .uj-home-sections .uj-card-body{padding:24px}
        ...
        .uj-home-sections .uj-text-link{display:inline-block;margin-top:16px;font-weight:700;color:var(--uj-pink);text-decoration:none}
        .uj-home-sections .uj-text-link:hover{color:#18b760}
        .uj-home-sections .uj-cta{background:linear-gradient(135deg,var(--uj-blue) 0%, #03224f 100%);position:relative;overflow:hidden}
        ...
        .uj-home-sections .uj-cta-inner{display:flex;align-items:center;justify-content:space-between;gap:30px}
        ...
        .uj-home-sections .uj-btn{display:inline-flex;align-items:center;justify-content:center;padding:16px 26px;border-radius:10px;text-decoration:none;font-weight:800;transition:all .3s ease;border:2px solid transparent}
        .uj-home-sections .uj-btn-primary{background:var(--uj-pink);color:#fff}
        .uj-home-sections .uj-btn-primary:hover{background:#18b760;color:#fff}
        .uj-home-sections .uj-btn-secondary{background:transparent;color:#fff;border-color:#fff}
        .uj-home-sections .uj-btn-secondary:hover{background:#18b760;border-color:#18b760;color:#fff}
        ...
        .uj-home-sections .uj-impact{background:#fff}
        .uj-home-sections .uj-events{background:#f8fafc}
        ...
        @media (max-width: 680px){
            .uj-home-sections .uj-section{padding:70px 0}
